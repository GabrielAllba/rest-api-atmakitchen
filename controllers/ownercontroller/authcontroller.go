...
func Login(c *gin.Context){
	...
	// Sign and get the complete encoded token as a string using the SECRET_OWNER
	tokenString, err := token.SignedString([]byte(os.Getenv("SECRET_OWNER")))
...
func Validate(c *gin.Context) {
    ...
    token, err := jwt.Parse(tokenString, func(token *jwt.Token) (interface{}, error) {
        ...
        return []byte(os.Getenv("SECRET_OWNER")), nil
    })
